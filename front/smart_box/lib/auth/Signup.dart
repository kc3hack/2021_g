...
import 'package:smart_box/auth/ConfirmRegistration.dart';
import 'package:smart_box/auth/Login.dart';
...
class Signup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar:
            AppBar(title: Text('新規ユーザ登録'), automaticallyImplyLeading: false),
  ...
  void _signUp(BuildContext context) async {
    try {
      ...
      attributes.add(
          new AttributeArg(name: 'email', value: _mailAddressController.text));
